...
namespace EmployCrud.Controllers
{
    ...
    public class EmploysController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Employ>>> GetEmployees()
        {
            ...
            Console.WriteLine(SendMail.MailInfo("owkbasha@gmail.com", "Dotnet Code", "This is My First Mail in Dotnet"));
        ...
        public async Task<ActionResult<Employ>> GetEmploy(int id)
        {
            try
            {
                string smtpUser = "vasimbasha@gmail.com"; // Gmail login account
                string appPassword = "hfol wjgf apqn bvhw";      // App password from Google
                string fromAddress = "vasimbasha@gmail.com"; // Must be allowed as alias
                string toAddress = "vasim@gmail.com";
